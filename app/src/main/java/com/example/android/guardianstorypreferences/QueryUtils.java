...
public final class QueryUtils {
    ...
    /**
     * Query the Guardian and return a list of {@link Story} objects.
     */
    ...
    private static List<Story> extractFeatureFromJson(String storyJSON) {
        ...
        try {
            ...
            JSONArray storyArray = jsonResults.getJSONArray("results");
            ...
            for (int i = 0; i < storyArray.length(); i++) {
                ...
                // Get author's name from "tags" array
                ...
                // Create a new {@link Story} object with the publicationDate, title, section,
                // and url from the JSON response.
                Story story = new Story(publicationDate, title, section, url, author);
